...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for PosDistribution in livingGhostPositionDistributions:
            ghostPos.append(PosDistribution.argMax())  
        ...
        for position in ghostPos:
            if livingGhostPositionDistributions[i][position] > prob:
                prob = livingGhostPositionDistributions[i][position]
                pos = position
            i += 1
        ...
        for action in legal:
            ...
            minDist.append((self.distancer.getDistance(successorPosition, pos),action))
        
        return min(minDist) [1]
